...
const sampleWords = [
  ...
  { word: "COMPILER", description: "A program that translates code from high-level to machine-level language." },
  { word: "FUNCTION", description: "A reusable block of code that performs a specific task." },
  { word: "VARIABLE", description: "A named location used to store data in programming." },
  { word: "ALGORITHM", description: "A step-by-step procedure used for solving problems or performing tasks." },
  { word: "DEBUGGING", description: "The process of identifying and fixing errors in a program." },
  { word: "DATABASE", description: "A structured collection of data that can be easily accessed and managed." },
  { word: "NODEJS", description: "A JavaScript runtime built on Chrome's V8 engine used for server-side development." },
  { word: "OBJECT", description: "An instance of a class that contains both data and methods in object-oriented programming." }
];
    ...
    <div className="container">
      ...
      <div className="button-section">
        <div className="guess-section">
          <button onClick={restartGameFunction} className="restart-button">Restart</button>
